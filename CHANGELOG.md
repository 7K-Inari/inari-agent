...
* deliver ESO SecretStores to the tenant state repo ([#17](https://github.com/7K-Inari/inari-agent/issues/17)) ([80f6272](https://github.com/7K-Inari/inari-agent/commit/80f627269024d8fa3e3ed420203ed4d7ad961495))
